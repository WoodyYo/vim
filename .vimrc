...
set laststatus=2
set statusline=%F\ \ \|WIN:\ %{winnr()}\|\ %{VimBuddy()}%=\|BUF:\ %{winbufnr(winnr())}\|\ %-10.(%l,%c%V%)\ %p%%\ %L
autocmd! bufwritepost ~/.vimrc so ~/.vimrc 
autocmd Filetype help exec "set number"
autocmd QuickFixCmdPost * exec "cw 6"
autocmd bufenter * call Ch_dir()
"""""""""鍵映射""""""""""
...
map <leader>d :cd <C-R>=expand('%:p:h').'/'<Cr>
